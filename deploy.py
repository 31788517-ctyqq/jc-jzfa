...
DEPLOY_MAP = [
    ...
    ('preview/js/pages/quant-rank-fusion.js','both'),  # ★ 量化排行榜（main-fusion 引用）
    ('preview/js/pages/match-pk-fusion.js','both'),  # ★ PK 融合版（main-fusion 引用）
    ...
    ('server/core/datetime.js',           'both'),  # ★ V12: 北京时间统一工具
    ('server/backfill/index.js',          'both'),  # ★ V12: 统一回填入口
    # ★ V12: 回填脚本统一移至 server/backfill/
    ('server/backfill/bulk_outcome.js',     'both'),
    ('server/backfill/backfill_full_models.js', 'both'),
    ('server/backfill/backfill_consensus.js',   'both'),
    ('server/backfill/backfill_prediction_logs.js', 'both'),
    ('server/backfill/backfill_phase1_matches.js', 'both'),
    ('server/backfill/backfill_phase2_predict.js', 'both'),
    ('server/backfill/backfill_phase3_outcomes.js', 'both'),
    ('server/backfill/backfill_expert_consensus.js','both'),
