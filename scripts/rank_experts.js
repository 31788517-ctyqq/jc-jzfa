...
console.log('无排名前10:', unranked.slice(0, 10).map(e => e.nickname + ' rate:' + e.hit_rate + '% streak:' + e.streak).join(', '));
console.log('入选:', selected.length, '位专家');

fs.writeFileSync(__dirname + '/../server/expert_discovery.json', JSON.stringify({
