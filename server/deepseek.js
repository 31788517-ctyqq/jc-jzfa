...
请以 JSON 格式输出，结构如下：
{
  "confidence": 74,
  "基础面": {
    "概括": "积分排名是跌，防守同为亮点，进攻效率不佳",
    "积分排名": "两队均在各自联赛中游位置，本场结果对积分排名影响适中，双方抢分意愿较强。",
    "攻防全景数据": {
      "header": ["数据项", "主队", "客队"],
      "rows": [
        ["赛季场均进球", "1.4", "1.2"],
    ...
    "核心结论": "主队近期攻防表现优于客队，基本面略微占优。"
  },
  "状态面": {
    "概括": "主队状态稳定，客队核心缺阵影响大",
    "主队近况": "近6场3胜2平1负，状态稳定，上轮主场取得胜利，体能恢复充分。",
    "客队近况": "近6场1胜2平3负，状态低迷，上轮客场遭遇惨败，士气受挫。",
    "历史对阵": "近5次交手主队2胜2平1负略占上风，心理层面有一定优势。",
    "伤病影响": {
      "header": ["球队", "缺阵情况", "影响评估"],
      "rows": [
        ["主队", "主力后卫伤缺", "中"],
    ...
    "队内氛围": "主队更衣室氛围良好，核心球员配合默契。客队换帅后过渡期不稳定。",
    "核心结论": "主队状态面占优，客队伤病问题较为严重。"
  },
  "动机面": {
    "概括": "双方均有抢分需求，防守端投入度较高",
    "战意强度": "两队均在联赛中游位置，欧战资格仍有希望。主队主场战绩出色，客队换帅后士气高涨，双方均有抢分需求，防守端投入度较高。"
  },
  "对位面": {
    "概括": "攻防博弈·节奏控制·战术特点",
    "攻防博弈": "主队进攻偏慢速推进，客队擅长快速反击，中场争夺将是关键。",
    "节奏控制": "主队场均控球率52%略占优势，预计比赛节奏偏慢。",
    "主场氛围": "主队主场氛围热烈，球迷支持对客队造成一定压力。",
    "战术与教练风格": "主队教练偏好传控打法，客队教练擅长防守反击，教练风格对比鲜明。",
    "核心结论": "客队反击效率高，主队需警惕快速转换。"
  },
  "市场面": {
    "概括": "盘口解读·数据变化·诱导可能",
    "盘口与赔率": "初始盘口主队-0.25，水位稳定，市场对主队略占上风有共识。",
    "大小球": "大小球盘口偏低明显，进一步确认防守稳健的小球趋势。",
    "数据变化解读": "盘口从初始到当前保持稳定，无明显诱导倾向。",
    "诱导可能": "水位变化平稳，未见明显诱导痕迹。",
    "核心结论": "市场面对主队不败有较强支持，小球趋势确认。"
  },
  "核心看点": {
    "核心看点": "主队状态更佳且主场作战，客队核心球员缺阵影响较大。比赛节奏可能由主队掌控，看好主队不败。",
    "变数提醒": "客队若摆大巴可能造成平局，红黄牌因素需关注。"
  },
  "预测建议": [
    {"玩法": "胜平负", "建议方向": "主胜 / 平", "核心逻辑": "主队状态好，客队核心缺阵"},
    {"玩法": "大小球", "建议方向": "小球", "核心逻辑": "双方近期进球效率不高"},
    {"玩法": "比分预测", "建议方向": "1:0 / 1:1", "核心逻辑": "主队防守稳固"}
  ]
}`;
}
