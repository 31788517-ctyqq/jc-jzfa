...
const LEAGUE_HEAT_BASELINE = {
  ...
  欧冠: { mean: 1.3, std: 0.2, overheatZ: 1.5 },
  欧罗巴: { mean: 1.2, std: 0.17, overheatZ: 1.5 },
  ...
  波兰超: { mean: 1.0, std: 0.13, overheatZ: 1.5 },
