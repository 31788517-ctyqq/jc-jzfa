...
function makeSpfOdds(direction) {
  switch (direction) {
    ...
    case 'draw':
      return { home: 2.8, draw: 2.1, away: 3.2 };
    case 'away':
      return { home: 4.5, draw: 3.5, away: 1.8 };
    case 'even':
    default:
      return { home: 2.6, draw: 3.2, away: 2.7 };
  }
}
...
function makeOpenOdds(overrides) {
  return Object.assign({ home: 2.3, draw: 3.1, away: 3.0 }, overrides || {});
}
...
function makeLiveOdds(overrides) {
  return Object.assign({ home: 2.0, draw: 3.3, away: 3.8 }, overrides || {});
}
...
function makeRqspfOnlyOdds(overrides) {
  return Object.assign(
    {
      spf: {},
      rqspf: { home: 2.21, draw: 4.2, away: 2.28, handicap: 0 },
    },
    overrides || {},
  );
}
