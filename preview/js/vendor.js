...
export function setPaymentData(v) { _paymentData = v; }
...
export function api(action, data, retries) {
  ...
  var headers = { 'Content-Type': 'application/json', 'X-Device-Id': getDeviceId() };
  ...
  var pending = fetch(API, {
    ...
    .catch(function (err) {
      ...
      var canRetry = retries > 0 && !err.nonRetryable;
      if (canRetry) {
