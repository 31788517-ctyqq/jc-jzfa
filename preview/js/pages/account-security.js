...
function render() {
  ...
  root.innerHTML =
    ...
    '</div>' +
    '</div>' +
    '<img class="login-eagle" src="/assets/login-eagle.png?v=202606101600" alt="" loading="eager" decoding="async" onclick="switchTab(\'profile\')" style="cursor:pointer" title="返回个人中心" />' +
    '</div>' +
