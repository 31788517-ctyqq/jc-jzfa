...
c.connect({ host:'119.23.51.159', port:22, username:'root', password:'[REDACTED_PASS]', algorithms:{ kex:['diffie-hellman-group14-sha1'], serverHostKey:['ssh-rsa'] }, readyTimeout:10000 });
